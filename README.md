...
the specification. The WorldCupChain community invites you to add your token to our tokenlists!
...
2. Token must be added to a list that it qualifies for:
    * **[WorldCupChain Tokenlist](./WorldCupChain.tokenlist.json)**: Token must be on the Avalanche network.
...
1. Add an entry in the `tokens` field of the appropriate tokenlist. Please use the [checksum address](https://docs.ethers.io/v5/api/utils/address/#address). Here is an example using PNG:
    ```json
    {
      ...
      "name": "WorldCupChain",
      "symbol": "WCC",
      "logoURI": "https://raw.githubusercontent.com/WorldCupChaindex/tokens/main/assets/43114/0x60781C2586D68229fde47564546784ab3fACA982/logo_24.png"
    }
    ```
...
Token logos are [hosted here](https://github.com/WorldCupChaindex/tokens).